%MATLAB code for re-producing the RMSE results (TR-NeuroMHE)
clear
...
disp('==========================================================================================================')
%---load the TR-NeuroMHE estimation data---%
filename=['evaluation_vector_error_TR_NeuroMHE/disest_mhe_',key,'.csv'];
